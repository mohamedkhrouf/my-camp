...
class CommentP extends StatefulWidget {
  final comment;
  final eventId;
  const CommentP({Key key, this.comment, this.eventId}) : super(key: key);

  @override
  _CommentP createState() => _CommentP();
}

class _CommentP extends State<CommentP> {
  var liked = true;
  var comment;
  @override
  void initState() {

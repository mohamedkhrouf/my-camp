...
class EvComment extends StatefulWidget {
  @override
  _EvCommentState createState() => _EvCommentState();
  final yep;
  final id;
  const EvComment({Key key, this.yep, this.id}) : super(key: key);
}

class _EvCommentState extends State<EvComment> {
  var clicked = false;
  var user;
